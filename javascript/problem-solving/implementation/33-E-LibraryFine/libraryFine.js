...
function libraryFine(d1, m1, y1, d2, m2, y2) {
    ...
    if (y1 == y2) {
        ...
        if (m1 == m2) {
            // If return day is before or equal to due day
            if (d1 <= d2) {
                return 0;

            // If day is after, return fine
            } else {
                return (d1 - d2) * 15;
            }
        
        // If return month is before due month
        } else if (m1 < m2) {
            return 0;

        // If month is after, return fine
        } else {
            return (m1 - m2) * 500;
        }

    // If return year is before due year
    } else if (y1 < y2) {
        return 0;

    // If year is after, return fine
    } else {
        return 10000;
    }
}
